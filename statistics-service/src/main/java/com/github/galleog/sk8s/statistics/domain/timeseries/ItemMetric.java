package com.github.galleog.sk8s.statistics.domain.timeseries;

import com.github.galleog.sk8s.statistics.domain.Currency;
import com.github.galleog.sk8s.statistics.domain.Item;
import com.github.galleog.sk8s.statistics.domain.TimePeriod;
