package com.github.galleog.sk8s.statistics.controller;

import com.github.galleog.sk8s.statistics.domain.Account;
import com.github.galleog.sk8s.statistics.domain.timeseries.DataPoint;
import com.github.galleog.sk8s.statistics.service.StatisticsService;
...
public class StatisticsController {
    ...
    public void updateAccountStatistics(@PathVariable String accountName, @Valid @RequestBody Account account) {
