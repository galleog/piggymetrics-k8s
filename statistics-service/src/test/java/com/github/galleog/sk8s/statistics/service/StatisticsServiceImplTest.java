package com.github.galleog.sk8s.statistics.service;

import com.github.galleog.sk.statistics.domain.*;
import com.github.galleog.sk8s.statistics.domain.*;
import com.github.galleog.sk8s.statistics.domain.timeseries.DataPoint;
import com.github.galleog.sk8s.statistics.domain.timeseries.ItemMetric;
import com.github.galleog.sk8s.statistics.domain.timeseries.StatisticMetric;
import com.github.galleog.sk8s.statistics.repository.DataPointRepository;
...
public class StatisticsServiceImplTest {
    ...
    public void shouldSaveDataPoint() {
        ...
        when(ratesService.convert(any(Currency.class), any(Currency.class), any(BigDecimal.class))).thenAnswer(i ->
                ((BigDecimal) i.getArgument(2))
