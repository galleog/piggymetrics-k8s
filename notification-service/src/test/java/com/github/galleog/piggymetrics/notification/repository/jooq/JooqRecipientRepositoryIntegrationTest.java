...
/**
 * Integration tests for {@link JooqRecipientRepository}.
 */
@DataR2dbcTest
@Testcontainers
@ActiveProfiles("test")
@Import(JooqRecipientRepositoryIntegrationTest.DataSourceConfig.class)
@ImportAutoConfiguration(R2dbcJooqAutoConfiguration.class)
class JooqRecipientRepositoryIntegrationTest {
